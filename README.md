...
[![My Skills](https://skillicons.dev/icons?i=py,github,git,gitlab,bash,windows,apple,powershell,kali,ubuntu,kubernetes,linux,vim,vscode,docker,gcp,aws,terraform,ubuntu,azure,mysql,jenkins,html,css&perline=8)](https://skillicons.dev)
